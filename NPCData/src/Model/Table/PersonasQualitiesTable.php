...
use Vorien\NPCData\Model\Entity\PersonasQuality;

/**
 * PersonasQualities Model
 *
 * @property \Cake\ORM\Association\BelongsTo $Personas
 * @property \Cake\ORM\Association\BelongsTo $Qualities
 */
class PersonasQualitiesTable extends Table
{
