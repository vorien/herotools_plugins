...
use Vorien\NPCData\Model\Table\PersonasFlawsTable;

/**
 * Vorien\NPCData\Model\Table\PersonasFlawsTable Test Case
 */
class PersonasFlawsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \Vorien\NPCData\Model\Table\PersonasFlawsTable
     */
    public $PersonasFlaws;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PersonasFlaws') ? [] : ['className' => 'Vorien\NPCData\Model\Table\PersonasFlawsTable'];
        $this->PersonasFlaws = TableRegistry::get('PersonasFlaws', $config);
    }
