...
require_once(App::path('Lib', 'Vorien/Dashboard')[0] . 'ImageFunctions.php');
...
//		exit;
			...
			public function getResizedImage($file, $w, $h) {
				$imagepath = Plugin::path('Vorien/NPCData') . 'webroot' . DS . '/img/baldemar/' . $file;
				$output = ImageFunctions::resize_image($imagepath, $w, $h);
				header('Content-Type: image/jpeg');
				imagejpeg($output); //This displays image data converted in jpg
				exit;
			}
