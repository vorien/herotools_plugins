...
use Vorien\HeroCombat\Model\Table\UsersTable;

/**
 * Vorien\HeroCombat\Model\Table\UsersTable Test Case
 */
class UsersTableTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \Vorien\HeroCombat\Model\Table\UsersTable
     */
    public $Users;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Users') ? [] : ['className' => 'Vorien\HeroCombat\Model\Table\UsersTable'];
