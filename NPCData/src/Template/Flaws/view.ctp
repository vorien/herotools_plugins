<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Flaw'), ['action' => 'edit', $flaw->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Flaw'), ['action' => 'delete', $flaw->id], ['confirm' => __('Are you sure you want to delete # {0}?', $flaw->id)]) ?> </li>
...
<div class="flaws view large-9 medium-8 columns content">
    <h3><?= h($flaw->name) ?></h3>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($flaw->personas as $personas): ?>
            <tr>
                <td><?= h($personas->id) ?></td>
