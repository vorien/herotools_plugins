<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Archetype'), ['action' => 'edit', $archetype->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Archetype'), ['action' => 'delete', $archetype->id], ['confirm' => __('Are you sure you want to delete # {0}?', $archetype->id)]) ?> </li>
...
<div class="archetypes view large-9 medium-8 columns content">
    <h3><?= h($archetype->name) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($archetype->personas)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($archetype->personas as $personas): ?>
            <tr>
                <td><?= h($personas->id) ?></td>
