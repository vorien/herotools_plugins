...
use Vorien\NPCData\Model\Entity\MotivationsPersona;

/**
 * MotivationsPersonas Model
 *
 * @property \Cake\ORM\Association\BelongsTo $Personas
 * @property \Cake\ORM\Association\BelongsTo $Motivations
 */
class MotivationsPersonasTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('motivations_personas');
