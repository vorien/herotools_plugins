...
use Vorien\NPCData\Model\Table\PersonasMotivationsTable;

/**
 * Vorien\NPCData\Model\Table\PersonasMotivationsTable Test Case
 */
class PersonasMotivationsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \Vorien\NPCData\Model\Table\PersonasMotivationsTable
     */
    public $PersonasMotivations;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PersonasMotivations') ? [] : ['className' => 'Vorien\NPCData\Model\Table\PersonasMotivationsTable'];
        $this->PersonasMotivations = TableRegistry::get('PersonasMotivations', $config);
    }
    ...
    {
        unset($this->PersonasMotivations);
