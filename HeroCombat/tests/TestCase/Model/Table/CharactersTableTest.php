...
use Vorien\HeroCombat\Model\Table\CharactersTable;

/**
 * Vorien\HeroCombat\Model\Table\CharactersTable Test Case
 */
class CharactersTableTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \Vorien\HeroCombat\Model\Table\CharactersTable
     */
    public $Characters;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Characters') ? [] : ['className' => 'Vorien\HeroCombat\Model\Table\CharactersTable'];
